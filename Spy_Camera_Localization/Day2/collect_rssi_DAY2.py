...
dev_mac = "d8:3a:dd:a2:47:2f"
iface_n = "wlan1"  # Interface for network adapter (do not modify)
duration = 120  # Number of seconds to sniff for
rssi_file_name = "rssi_midterm_day2.csv"  # Output RSSI CSV file name
joystick_file_name = "joystick_midterm_day2.csv"  # Output joystick CSV file name
...
def captured_packet_callback(pkt):
    ...
    if pkt.addr2 == dev_mac:
        write_to_file("rssi_midterm_day2.csv", [timestamp,pkt.addr1,pkt.addr2, pkt.dBm_AntSignal])
